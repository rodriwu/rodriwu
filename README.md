...
**Visual & Product Designer** · México 🇲🇽

I design digital products that bridge brand, UX, and development — turning strategy into interfaces that convert. Currently working with U.S.-based clients at [Omni Common](https://omnicommon.com), a growth agency.

---

### What I do

- End-to-end UX/UI design for web and product
- Design systems, style guides & component libraries
- Platform implementation (Framer, Webflow, WordPress)
- Visual identity & brand design
- Lottie animations & interactive prototypes
